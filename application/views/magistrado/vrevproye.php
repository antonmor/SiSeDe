<div id="ppal" style="margin-left:10%; width:90%;height:100%; text-align:center;">
		...
		<div id="documentos" class="tab-pane fade">
	    		...
	    		<div class="row" style="margin-left:10%;">
	  			<div class="col-xs-6 col-xs-offset-2">
		  				...
		  				?>
		  				<tr>
		  					<td style="text-align:left"> <img src="<?php echo base_url();  ?>Imagenes/pdf1.jpg" title="Expedientes" style="width:30px; height:30px;"></td>
  ...
  <!-- Modal -->
<div class="modal" id="archpdf" role="dialog">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <?php
            $fi= base_url().$directorio."/".$cadena.".pdf";
            //echo $fi;
          ?>
          <embed src="<?php echo $fi; ?>" style="margin-left:5%; width:90%;height:700px;">
        </div>
