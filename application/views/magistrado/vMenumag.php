<nav class="navbar navbar-default navbar-static-top">
	...
	<div class="collapse navbar-collapse pull-right">
		<ul class="nav navbar-nav">
			...
			<li class="active">
				<a href="/SiSeDe/index.php/cproypend">Proyectos de Sentencias<span class="badge badge-error">42</span></a>				
			</li>
			<li class="dropdown"> 
 			<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Mi cuenta(
				...
				<ul class="dropdown-menu">
					<li><a href="/SiSeDe/index.php/cproypend">Proyectos de Sentencias</a></li>
